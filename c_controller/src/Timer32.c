...
void Timer32_1_Init(void(*task)(void), unsigned long period, enum timer32divider div) {
    ...
    TIMER32_CONTROL1 = TIMER32_CONTROL_ENABLE | TIMER32_CONTROL_MODE | TIMER32_CONTROL_IE | TIMER32_CONTROL_SIZE | div;
...
void Timer32_2_Init(void(*task)(void), unsigned long period, enum timer32divider div) {
    ...
    // bit0,             1=one shot mode, 0=wrapping mode
    //TIMER32_CONTROL2   
    TIMER32_CONTROL2 = TIMER32_CONTROL_ENABLE | TIMER32_CONTROL_MODE | TIMER32_CONTROL_IE | TIMER32_CONTROL_SIZE | div;
